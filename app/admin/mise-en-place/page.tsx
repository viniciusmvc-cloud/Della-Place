      ...
      {loading ? (
        ...
        <>
            ...
            <section className="rounded-xl border border-primary-100 bg-white p-5">
              ...
              <ul className="grid gap-2 md:grid-cols-2">
                {data.byFlavor.map((f) => (
                  ...
                  >
                    <span className="text-primary-500">{f.name}</span>
                    <span
          ...
          <section className="rounded-xl border border-primary-100 bg-white">
            <h2 className="border-b border-primary-100 p-5 text-xs font-medium uppercase tracking-widest text-primary-500/60">
                    ...
                    <div className="min-w-[110px] text-right">
                      {ing.ok ? (
                        ...
                        <span className="rounded-full bg-amber-200 px-3 py-1 text-xs text-amber-900">
                          comprar {fmt(ing.deficit)} {ing.unit}
                        </span>
                      )}
                    </div>
                  </li>
                ...
                {data.ingredients
                  ...
                  .map((i) => (
                    <li key={i.stockItemId}>
                      {i.stockName} — {fmt(i.deficit)} {i.unit}
                    </li>
                  ))}
              </ul>
            </section>
